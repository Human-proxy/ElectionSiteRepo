package nl.hva.dederdekamer.election_backend.XMLParser.api;
...
public class ElectionController {
     ...
     */
    // Support both POST and GET so you can call this from a browser GET request
    ...
    /**
     * Clear the election cache. Useful during development.
     * In production, you might want to secure this endpoint or remove it.
     */
