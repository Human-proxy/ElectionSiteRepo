 ...
 * being processed.
 * <br/>
 * In case an unknown tag or attribute is being processed this will be logged as a warning
 * using the SLF4J logging framework.<br/>
 * <br/>
 * <i><b>Refactored: </b>Proper logging framework implemented using SLF4J instead of System.err output.</i>
 */
